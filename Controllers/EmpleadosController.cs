...
namespace HotelGestion.Controllers_
{
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdTurno,IdPersona,Documento,Nombre,Apellido,Telefono,Correo,Cargo,Salario,FechaContratacion")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdTurno,IdPersona,Documento,Nombre,Apellido,Telefono,Correo,Cargo,Salario,FechaContratacion")] Empleado empleado)
        {
